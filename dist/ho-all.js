        ...
        var Options = (function () {
            ...
            Options.prototype.processMap = function () {
                ...
                components.forEach(function (c) {
                    ho.components.registry.mapping[c] = _this.map + 'components/' + c + '/' + c + '.js';
                });
                attributes.forEach(function (a) {
                    ho.components.registry.mapping[a] = _this.map + 'attributes/' + a + '/' + a + '.js';
                });
                stores.forEach(function (s) {
                    ho.flux.registry.mapping[s] = _this.map + 'stores/' + s + '/' + s + '.js';
                });
            };
